...
Desirable_Loot_Router.get("/SingleDesirableLoot/:id", findSingleDesirableLoot);

// //POST METHODS:
Desirable_Loot_Router.post("/CreateSingleDesirableLoot", createSingleDesirableLoot);

// //PUT METHODS:
Desirable_Loot_Router.put("/UpdateSingleDesirableLoot/:id", updateDesirableLoot);

// //Delete METHODS:
Desirable_Loot_Router.delete("/DeleteSingleItem/:id", deleteDesirableLoot);
